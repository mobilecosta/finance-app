...
class WorkerDeploy extends EasCommand_1.default {
    ...
    static usage = [
        (0, chalk_1.default) `deploy {dim [options]}`,
        `deploy --prod`,
    ...
    static flags = {
        ...
        'dev-domain': core_1.Flags.string({
            description: `Custom preview URL subdomain to assign to the project on its first deployment, e.g. "my-app" for my-app.${logs_1.EXPO_BASE_DOMAIN}.app. Required with --non-interactive if you want to customize the preview URL.`,
            helpValue: 'name',
        }),
    ...
    sanitizeFlags(flags) {
        ...
        if (devDomainName !== undefined) {
            (0, deployment_1.assertValidDevDomainName)(devDomainName);
        }
        return {
            nonInteractive,
            json,
