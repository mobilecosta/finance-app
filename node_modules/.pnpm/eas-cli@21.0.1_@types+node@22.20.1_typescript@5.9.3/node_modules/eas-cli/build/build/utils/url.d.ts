...
export declare function getProjectPageUrl(accountName: string, projectName: string, page?: string | null): string;
...
export declare function getDeviceRunSessionUrl(accountName: string, projectName: string, deviceRunSessionId: string): string;
/**
