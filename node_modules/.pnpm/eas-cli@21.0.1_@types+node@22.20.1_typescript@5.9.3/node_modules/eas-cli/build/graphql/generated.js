...
var AppObserveCustomEventListOrderByField;
(function (AppObserveCustomEventListOrderByField) {
    AppObserveCustomEventListOrderByField["Timestamp"] = "TIMESTAMP";
})(AppObserveCustomEventListOrderByField || (exports.AppObserveCustomEventListOrderByField = AppObserveCustomEventListOrderByField = {}));
...
var AppObserveErrorBreakdownDimension;
(function (AppObserveErrorBreakdownDimension) {
    AppObserveErrorBreakdownDimension["AppVersion"] = "APP_VERSION";
    AppObserveErrorBreakdownDimension["Country"] = "COUNTRY";
    AppObserveErrorBreakdownDimension["Device"] = "DEVICE";
    AppObserveErrorBreakdownDimension["Os"] = "OS";
})(AppObserveErrorBreakdownDimension || (exports.AppObserveErrorBreakdownDimension = AppObserveErrorBreakdownDimension = {}));
var AppObserveErrorGroupsOrderBy;
(function (AppObserveErrorGroupsOrderBy) {
    AppObserveErrorGroupsOrderBy["FirstSeen"] = "FIRST_SEEN";
    AppObserveErrorGroupsOrderBy["LastSeen"] = "LAST_SEEN";
    AppObserveErrorGroupsOrderBy["MostFrequent"] = "MOST_FREQUENT";
    AppObserveErrorGroupsOrderBy["MostUsers"] = "MOST_USERS";
})(AppObserveErrorGroupsOrderBy || (exports.AppObserveErrorGroupsOrderBy = AppObserveErrorGroupsOrderBy = {}));
var AppObserveErrorSeverity;
(function (AppObserveErrorSeverity) {
    AppObserveErrorSeverity["Error"] = "ERROR";
    AppObserveErrorSeverity["Fatal"] = "FATAL";
})(AppObserveErrorSeverity || (exports.AppObserveErrorSeverity = AppObserveErrorSeverity = {}));
...
var AppStoreConnectBuildProcessingState;
(function (AppStoreConnectBuildProcessingState) {
    AppStoreConnectBuildProcessingState["Failed"] = "FAILED";
    AppStoreConnectBuildProcessingState["Invalid"] = "INVALID";
    AppStoreConnectBuildProcessingState["Processing"] = "PROCESSING";
    AppStoreConnectBuildProcessingState["Valid"] = "VALID";
})(AppStoreConnectBuildProcessingState || (exports.AppStoreConnectBuildProcessingState = AppStoreConnectBuildProcessingState = {}));
var AppStoreConnectBuildUploadState;
(function (AppStoreConnectBuildUploadState) {
    AppStoreConnectBuildUploadState["AwaitingUpload"] = "AWAITING_UPLOAD";
    AppStoreConnectBuildUploadState["Complete"] = "COMPLETE";
    AppStoreConnectBuildUploadState["Failed"] = "FAILED";
    AppStoreConnectBuildUploadState["Processing"] = "PROCESSING";
})(AppStoreConnectBuildUploadState || (exports.AppStoreConnectBuildUploadState = AppStoreConnectBuildUploadState = {}));
...
var AppStoreConnectWorkflowConnectionStatus;
(function (AppStoreConnectWorkflowConnectionStatus) {
    /** An App Store Connect app connection is linked to this project. */
    AppStoreConnectWorkflowConnectionStatus["HasWorkflowsIsConnected"] = "HAS_WORKFLOWS_IS_CONNECTED";
    /** The project has App Store Connect-triggered workflows but no connection. */
    AppStoreConnectWorkflowConnectionStatus["HasWorkflowsMissingConnection"] = "HAS_WORKFLOWS_MISSING_CONNECTION";
    /** The project has no workflows with an on.app_store_connect trigger. */
    AppStoreConnectWorkflowConnectionStatus["NoAppStoreConnectWorkflows"] = "NO_APP_STORE_CONNECT_WORKFLOWS";
})(AppStoreConnectWorkflowConnectionStatus || (exports.AppStoreConnectWorkflowConnectionStatus = AppStoreConnectWorkflowConnectionStatus = {}));
...
(function (EasServiceMetric) {
    ...
    EasServiceMetric["ObserveEvents"] = "OBSERVE_EVENTS";
...
(function (EasTotalPlanEnablementUnit) {
    ...
    EasTotalPlanEnablementUnit["Event"] = "EVENT";
...
var PostHogDeepLinkPurpose;
(function (PostHogDeepLinkPurpose) {
    PostHogDeepLinkPurpose["Dashboard"] = "DASHBOARD";
    PostHogDeepLinkPurpose["Observability"] = "OBSERVABILITY";
    PostHogDeepLinkPurpose["Project"] = "PROJECT";
})(PostHogDeepLinkPurpose || (exports.PostHogDeepLinkPurpose = PostHogDeepLinkPurpose = {}));
var PostHogRegion;
...
var UpdatesTimelineItemType;
(function (UpdatesTimelineItemType) {
    UpdatesTimelineItemType["EmbeddedUpdate"] = "EMBEDDED_UPDATE";
    UpdatesTimelineItemType["UpdateGroup"] = "UPDATE_GROUP";
})(UpdatesTimelineItemType || (exports.UpdatesTimelineItemType = UpdatesTimelineItemType = {}));
...
var WorkflowDispatchInputType;
(function (WorkflowDispatchInputType) {
...
})(WorkflowDispatchInputType || (exports.WorkflowDispatchInputType = WorkflowDispatchInputType = {}));
...
(function (WorkflowRunTriggerEventType) {
    ...
    WorkflowRunTriggerEventType["GithubPullRequestBaseRefChanged"] = "GITHUB_PULL_REQUEST_BASE_REF_CHANGED";
    WorkflowRunTriggerEventType["GithubPullRequestEdited"] = "GITHUB_PULL_REQUEST_EDITED";
