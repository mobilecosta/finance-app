...
class BuildStep extends BuildStepOutputAccessor {
    ...
    constructor(ctx, { id, displayName, inputs, outputs, command, fn, workingDirectory: maybeWorkingDirectory, shell, supportedRuntimePlatforms: maybeSupportedRuntimePlatforms, env, ifCondition, timeoutMs, __metricsId, __hookId, }) {
    ...
    async executeAsync() {
        try {
            ...
            const error = err instanceof Error
                ? err
                : new errors_1.BuildStepRuntimeError(`Build step "${this.displayName}" threw a non-Error value: ${util_1.default.inspect(err)}`);
    ...
    shouldExecuteStep() {
        ...
        return (0, jsepEval_1.evaluateIfCondition)(this.ifCondition, this.ctx.global.getIfConditionContext({
