...
class AbstractConfigParser {
    ...
    async parseAsync() {
        const { buildSteps, buildFunctionById, hooksByAnchorStep } = await this.parseConfigToBuildStepsAndBuildFunctionByIdMappingAsync();
        const workflow = new BuildWorkflow_1.BuildWorkflow(this.ctx, {
            buildSteps,
